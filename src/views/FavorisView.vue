    ...
    <div class="favoris-page">
      <div class="container">
        ...
        <div v-if="favoris.length === 0" class="empty-state">
          ...
          <RouterLink to="/home" class="discover-link">Explorer les films</RouterLink>
        </div>
        ...
        <div v-else class="movie-grid">
          <div v-for="movie in favoris" :key="movie.id" class="movie-card">
            ...
            <div class="movie-details">
              <h3>{{ movie.title }}</h3>
              <p class="summary">{{ movie.summary ? movie.summary.slice(0, 80) : '' }}...</p>
...
<style scoped>
/* --- Correction : Ajout de scoped et des styles manquants --- */
h1 { font-size: 2.5rem; margin-bottom: 2rem; color: #f1c40f; text-align: center; }
...
.movie-details h3 { margin-bottom: 0.5rem; color: white; }
...
.rating-text { color: #f1c40f; font-weight: bold; }
...
.discover-link { color: #f1c40f; text-decoration: underline; margin-top: 1rem; display: inline-block; }
</style>